...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPauseDrawable = getResources().getDrawable(R.drawable.uamp_ic_pause_white_48dp);
        mPlayDrawable = getResources().getDrawable(R.drawable.uamp_ic_play_arrow_white_48dp);
    ...
    private void updateProgress() {
        ...
        long currentPosition = mLastPlaybackStateCompat.getPosition();
        if (mLastPlaybackStateCompat.getState() != PlaybackStateCompat.STATE_PAUSED) {
            // Calculate the elapsed time between the last position update and now and unless
            // paused, we can assume (delta * speed) + current position is approximately the
            // latest position. This ensure that we do not repeatedly call the getPlaybackState()
            // on MediaController.
            long timeDelta = SystemClock.elapsedRealtime() -
                    mLastPlaybackStateCompat.getLastPositionUpdateTime();
            currentPosition += (int) timeDelta * mLastPlaybackStateCompat.getPlaybackSpeed();
        }
